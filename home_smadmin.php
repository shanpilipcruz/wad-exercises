<?php
	...
	$items_connection = mysqli_connect('localhost','root','','school_projects');
	$supermarket_query = "SELECT * FROM supermarket";
	    ...
	    <div class="container">
	        ...
	        <div id="navbarCollapse" class="collapse navbar-collapse">
	            <ul class="nav navbar-nav navbar-right">
	                <li><a href="home_smadmin.php">Home</a></li>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<?php 
					$connect = mysqli_connect('localhost','root','','school_projects');
					$results = mysqli_query($connect, "SELECT * FROM supermarket");
				?>
